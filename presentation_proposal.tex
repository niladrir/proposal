...
\begin{document}
%--------------------------------------Title--------------------------------------------------
\title{Application of Lineup Protocols in different scenarios }
...
%\begin{frame}
%	\begin{itemize}
%		\item Undergrad Major: Statistics
%		  \begin{itemize}
%			  \item 1998: graduated from University of Dhaka, Bangladesh.
...
%		  \end{itemize}			 
%		\item Ball State University: 2005-2007
%		  \begin{itemize}
...
%    \item Validation
%		  \begin{itemize}
%			  \item test Statistic and comparison with null distribution
%			  \item visual vs Mathematical Inference
%			  \item p-value and Type-I error
%			  \item power of the visual test
%		  \end{itemize}
%    \item Setting up a turk experiment
%		  \begin{itemize}
%			  \item simulation based experiment
%			  \item survey Setting
%			  \item demonstration of the web site
%		  \end{itemize}	  	  		
%    \item Analysis of turk data
%		  \begin{itemize}
%			  \item survey results, p-value vs percent correct and time taken for a response
%			  \item estimation of power from survey data
%			  \item influence of demographic factors
%		  \end{itemize}	  
%    \item Application to pharmaceutical data
%		  \begin{itemize}
%			  \item planning to work as an intern with Novartis in this summer
  ...
  \frametitle{Test Statistic}
	...
	\begin{columns}
		...
		\begin{column}{0.6\textwidth}
			 \begin{center} \scalebox{0.5}{\includegraphics{test_statistic.pdf}} \end{center}
		\end{column}
...
\hline
  Hypothesis & \hspace{-1.1cm} $H_0: \mu_1= \mu_2$ vs $H_a: \mu_1 \ne \mu_2$& $H_0: \mu_1 = \mu_2$ vs $H_a: \mu_1 \ne \mu_2$\\
%  \vspace{0.5cm}	
...
%\vspace{0.5cm}				  
 Test statistic & $T(y)=\frac{\bar{y}_1 - \bar{y}_2}{s\sqrt{\frac{1}{n_1} + \frac{1}{n_2}}}$ & $T(y)=$ \begin{minipage}[h]{1cm} \begin{center} \scalebox{0.12}{\includegraphics{data-dot.pdf}} \end{center} \end{minipage} \\
				 
 & \begin{minipage}[h]{1cm} \begin{center} \scalebox{0.25}{\includegraphics{down_arrow.pdf}} \end{center} \end{minipage} & \begin{minipage}[h]{1cm} \begin{center} \scalebox{0.25}{\includegraphics{down_arrow.pdf}} \end{center} \end{minipage} \\
				 
 Null Distribution & $f_{T(y)}(t); $\begin{minipage}[h]{1cm} \begin{center} \scalebox{0.12}{\includegraphics{stat_mathematical_test.pdf}} \end{center} \end{minipage} & $f_{T(y)}(t); $ \begin{minipage}[h]{1cm} \begin{center} \scalebox{0.19}{\includegraphics{lineup-dot.pdf}} \end{center} \end{minipage} \\
...
\end{itemize}
\begin{center}
\scalebox{0.18}{\includegraphics{plot_2a_1d.pdf}}
\scalebox{0.18}{\includegraphics{plot_20a_1d.pdf}}
\scalebox{0.18}{\includegraphics{plot_50a_1d.pdf}}
\scalebox{0.18}{\includegraphics{plot_100a_1d.pdf}}
\end{center}
\end{frame}
...
\end{itemize}
\begin{center}
\scalebox{0.18}{\includegraphics{plot-true3.pdf}}
\scalebox{0.18}{\includegraphics{plot-true20.pdf}}
\scalebox{0.18}{\includegraphics{plot-true50.pdf}}
\scalebox{0.18}{\includegraphics{plot-true100.pdf}}
\end{center}
\end{frame}
