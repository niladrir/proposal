...
\end{eqnarray*}
The usual convention is to take the number of bins equal to the square root of the number of observations. So we take $p = q = \ceil[\big]{\sqrt{n}}$ where $\ceil[\big]{x}$ is the smallest integer greater than or equal to $x$. \\
