...
\end{eqnarray*}
The usual convention is to take the number of bins equal to the square root of the number of observations. So we take $p = q = \lceil[\big]{\sqrt{n}}\rceil$ where $\lceil[\big]{x}\rceil$ is the smallest integer greater than or equal to $x$. \\
...
%\begin{figurehere}
   \centering
       \scalebox{0.38}{\includegraphics{data4.pdf}}
%      \scalebox{0.3}{\includegraphics{data1_30_5_1.pdf}}
%       \scalebox{0.3}{\includegraphics{data1_50_5_1.pdf}}
